...
-- CREATE DATABASE dldjaab0u9g55 WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';

-- ALTER DATABASE namisportal OWNER TO postgres;

-- \connect dldjaab0u9g55
